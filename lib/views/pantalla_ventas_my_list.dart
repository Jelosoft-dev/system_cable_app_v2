...
class PantallaVentasMyList extends StatefulWidget {
  const PantallaVentasMyList({Key? key}) : super(key: key);

  @override
  State<PantallaVentasMyList> createState() => _PantallaVentasMyListState();
}

class _PantallaVentasMyListState extends State<PantallaVentasMyList> {
